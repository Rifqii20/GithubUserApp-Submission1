...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull ConstraintLayout rootView, @NonNull TextView descApp,
      @NonNull ImageView githubLogo, @NonNull ProgressBar progressBar) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.github_logo;
      ImageView githubLogo = ViewBindings.findChildViewById(rootView, id);
      if (githubLogo == null) {
        break missingId;
      }
      ...
      return new ActivitySplashScreenBinding((ConstraintLayout) rootView, descApp, githubLogo,
          progressBar);
    }
